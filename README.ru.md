...
| Computer Use | Поиск окон и управление с разрешением для конкретного приложения, доступом на задачу и allowlist под управлением app-server |
...
Computer Use включается отдельно для каждой задачи. Каждое чтение или действие
