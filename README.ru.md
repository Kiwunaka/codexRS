...
текущего распакованного бинарника и никогда не меняет существующий entry.
Ubuntu CI собирает и тестирует бинарник, но распакованный архив ещё не проходил
desktop smoke-тест. Linux Computer Use даёт только
ограниченное read-only наблюдение со скриншотами окон X11/XWayland при
непустом `DISPLAY`. Извлечение текста, ввод, запуск приложений, постоянные
