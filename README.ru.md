...
> [!IMPORTANT]
> Текущее дерево готовится как `v0.1.0-rc.2`. На Windows уже пройден сквозной
...
| Платформы | Windows проверен исходной сборкой; в Ubuntu CI собираются и тестируются UI, app-server, Git и PTY; Linux Computer Use недоступен в RC2 |

Computer Use в RC2 доступен только на Windows и включается отдельно для каждой
...
архив ещё не проходил desktop smoke-тест. Linux Computer Use недоступен в RC2;
